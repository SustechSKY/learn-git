...
public class EasyButtonComponent extends JComponent {
    Image Image1;
    Image Image2;
    int state = 0;
    Menu thisMenu;

    public EasyButtonComponent(Image image1, Image image2) {
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        if(e.getID() == MouseEvent.MOUSE_PRESSED) {
            System.out.println("Easy is clicked");
            ChessGameFrame mainFrame = new ChessGameFrame(720, 720,1);
