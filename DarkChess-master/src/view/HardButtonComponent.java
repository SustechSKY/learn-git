...
public class HardButtonComponent extends JComponent {
    Image Image1;
    Image Image2;
    int state = 0;
    Menu thisMenu;

    public HardButtonComponent(Image image1, Image image2) {
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        if (e.getID() == MouseEvent.MOUSE_PRESSED) {
            System.out.println("Hard is clicked");
            ChessGameFrame mainFrame = new ChessGameFrame(720, 720,3);
